...
const MortgageApplicationQueueProcessor_1 = __importDefault(require("../src/MortgageApplicationQueueProcessor"));
const Customer_1 = __importDefault(require("../src/domain/Customer"));
const NotEligibleForMortgageException_1 = __importDefault(require("../src/exceptions/NotEligibleForMortgageException"));
const WrongDataException_1 = __importDefault(require("../src/exceptions/WrongDataException"));
describe("MortgageApplicationQueueProcessor", () => {
    ...
    describe("unhappy path test", () => {
        it(`given a customerId when not valid then request fails`, () => {
            ...
            assert_1.default.throws(() => process(customerId, amountRequested, customerRepositoryMock), WrongDataException_1.default);
        });
    });
});
